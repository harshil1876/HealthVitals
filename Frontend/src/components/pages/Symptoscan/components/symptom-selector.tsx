...
function isSymptomAlreadySelected(selectedSymptoms: Symptom[], symptomName: string) {
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="md:col-span-2 space-y-4">
          <h3 className="text-lg font-medium">
            {selectedBodyArea
              ? `${bodyAreas.find((a) => a.id === selectedBodyArea)?.name} Symptoms`
              : "Select a body area"}
          </h3>
          {selectedBodyArea ? (
      ...
      <div className="space-y-4">
        ...
        {selectedSymptoms.length > 0 ? (
          ...
          <div className="flex items-center justify-center h-32 border rounded-md bg-muted/20">
            <p className="text-muted-foreground">
              No symptoms selected. Select from the list above or add custom symptoms.
            </p>
          </div>
        )}
