...
const InsightsPage = ({ user }) => {
  ...
  const renderTrends = () => (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-2xl font-bold text-gray-900">Health Insights & Analytics</h2>
          <p className="text-gray-600">AI-powered analysis of your health conversations and personalized recommendations</p>
        </div>
      ...
      <div>
        <h3 className="text-lg font-semibold mb-4">Conversation Patterns</h3>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="text-center">
          <div className="text-3xl font-bold text-gray-900">42h</div>
  ...
  const renderVitalSigns = () => (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-gray-900">Vital Signs Tracking</h2>
  ...
  const renderTopics = () => (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-gray-900">Conversation Topic Analysis</h2>
  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      {activeInsight === "trends" && renderTrends()}
      {activeInsight === "recommendations" && renderRecommendations()}
      {activeInsight === "vitalsigns" && renderVitalSigns()}
      {activeInsight === "topics" && renderTopics()}
    </div>
  );
};
