...
import { X as LucideX, Search as LucideSearch, Play, Pause, Download, Activity, User, Mic, FileText } from 'lucide-react';
            ...
            <div className="flex-1 max-w-md">
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <LucideSearch size={16} className="text-text-secondary" />
                </div>
                <Input
                  type="search"
        ...
        >
          {filteredTranscript.length === 0 ? (
            <div className="text-center py-12">
              <LucideSearch size={48} className="text-text-muted mx-auto mb-4" />
