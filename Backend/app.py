...
logging.basicConfig(level=logging.INFO, 
                   ...
                   handlers=[logging.FileHandler(os.path.join(LOG_DIR, "api.log"), encoding='utf-8'), logging.StreamHandler()])
...
input_log_path = os.path.join(LOG_DIR, "input.log")
...
# --- ENDPOINTS FOR FRONTEND INTEGRATION (FINALIZED) ---
...
# 4. PDF Generation (public, overview)
...
# 3. Medical Report Analysis (file upload)
